...
- `self_past_candidates`: past PKOS notes (created 7-90 days ago) on a topic similar to today's, ranked to prefer `20-Ideas/` (the user's own opinions, likely to carry a stance) over `10-Knowledge/` excerpts — the writer picks the one whose stance contradicts today's argument
