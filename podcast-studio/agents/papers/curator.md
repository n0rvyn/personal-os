...
`concepts`：从选中论文的 abstract 提炼 **2-5 个核心概念 tag**（中文短词，如 "视频理解" / "agent 循环" / "记忆蒸馏"）。这些 tag 写进 paper-log，供**以后**的选题去重——下一期你会读到它们，避开概念太近的论文。不是越多越好，挑最能代表这篇"在讲什么"的 2-5 个。abstract 里没有的概念不要编。
